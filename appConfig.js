...
const users = [
  new user(
    ...
    "6ebfe5e505b06fbd6bef17c2d5ed959c3b1f2346",
  ), // admin
  new user(
    "4e25b1e22c001bf1440d77d072fd5602a97f2a17",
    "825b97c9e24661c66b850ae7c9da9f0e6dffbc04",
  ), // updated!
  new user(
    "114443ec5ec52ae27ba5d46bbc77cb9716ce065b",
    "ebf0e1a684bd5271c183924b5cda55fe348af94a",
  ), // updated!
  ...
  new user(
    "267a9a7c7e94dec97d8368bfa8c6fb9db7afa6e2",
...
const memberData = {
  hierarchy: {
    chairman: [encrypt("Vishesh Kudva")],
    high_council: [encrypt("Luca Korolev"), encrypt("Kaidi Hsu")],
    honoured_members: [],
    members: [
      encrypt("Orion Huang"),
      encrypt("Angus McDonnell"),
      encrypt("Myeongjo Seo"),
      encrypt("Connor Borrell"),
    ],
    caution: [encrypt("Marcus"), encrypt("Aaron Liu")],
    neutral: [],
    protesters: [encrypt("Roland Liu"), encrypt("Leni Reid")],
    enemies: [
      encrypt("Mr Bevan Galbraith"),
      encrypt("Aaron Liu"),
      encrypt("Mr Timothy Dent"),
    ],
  ...
  roles: {
    ...
    head_of_defence: [encrypt("Vishesh Kudva")],
    head_of_secretery: [encrypt("Kaidi Hsu")],
    award_manager: [],
    web_developer: [
      encrypt("Vishesh Kudva"),
      encrypt("Luca Korolev"),
      encrypt("Connor Borrell"),
    ],
  },
};
